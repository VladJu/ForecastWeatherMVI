package com.example.forecastweather.presenttion.ui.theme
...
object CardGradients {
    val gradients = listOf(
        ...
        Gradient(
            firstColor = Color(0xFF27A32C),
            secondColor = Color(0xFF25FFFF),
            thirdColor = Color(0xFF8BC34A),
            fourthColor = Color(0x7325FFFF),
        ),
        Gradient(
            firstColor = Color(0xFF379FFF),
            secondColor = Color(0xFF4021FF),
            thirdColor = Color(0xFF379FFF),
            fourthColor = Color(0x4D3F51B5),
        ),
        Gradient(
